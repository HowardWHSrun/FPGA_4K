...
This is the **original supplied model**, originally named `stacked_headboard_onebody (1).stl`. The separately generated shortened-bridge variant is not included here. The original author's identity has not been verified, so this file is not attributed to Gerald.
